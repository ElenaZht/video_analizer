...
const VideoPlayer = () => {
  ...
  const stepForward = event => {
    // changing the "currentTime" of video elemnet causes to video to seek to this time.
    // we using this approach in order to poccess video quickly (few frames per second
