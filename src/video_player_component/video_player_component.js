...
const VideoPlayer = () => {
    ...
    return (
        <div className='vp_main'>
                <canvas id="preview" ref={canvasRef} className= {videoFile ? 'loaded_file' : 'no_file'}></canvas>
                {videoFile && (
                ...
                <div className='controls'>
                    {videoFile &&<button onClick={play}>Play</button>}
                    {videoFile && <button onClick={stepForward}>Step Forward</button>}
                    <input type="file" onChange={handleFileUpload} />
                </div>
                {videoFile && <div className='treshold controls'>
                    <div>
